...
namespace WP_Rules\Dependencies\League\Container;

use WP_Rules\Dependencies\League\Container\Definition\{DefinitionAggregate, DefinitionInterface, DefinitionAggregateInterface};
use WP_Rules\Dependencies\League\Container\Exception\{NotFoundException, ContainerException};
use WP_Rules\Dependencies\League\Container\Inflector\{InflectorAggregate, InflectorInterface, InflectorAggregateInterface};
use WP_Rules\Dependencies\League\Container\ServiceProvider\{
    ServiceProviderAggregate,
    ServiceProviderAggregateInterface,
    ServiceProviderInterface
};
use WP_Rules\Dependencies\Psr\Container\ContainerInterface;
