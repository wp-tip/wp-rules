...
namespace WP_Rules\Dependencies\League\Container\ServiceProvider;

use Generator;
use WP_Rules\Dependencies\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use WP_Rules\Dependencies\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\WP_Rules\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
