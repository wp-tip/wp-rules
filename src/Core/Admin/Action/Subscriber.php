...
class Subscriber implements SubscriberInterface {
	...
	public function save_actions( $post_ID ) {
		...
		$post_rule_actions        = rules_recursive_sanitize_key( wp_unslash( $_POST['rule_actions'] ?? [] ) );// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		$post_rule_action_options = rules_recursive_sanitize_key( wp_unslash( $_POST['rule_action_options'] ?? [] ) );// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
