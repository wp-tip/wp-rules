...
class IsFrontPage extends AbstractCondition {
	...
	protected function init() {
		return [
			...
			'description' => __( 'Check whether the user is on front page.
			...
			If you set a static page for the front page of your site, this condition will be triggered when viewing that page.', 'rules' ),
